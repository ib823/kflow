...
class TestPublicHoliday(KerjaFlowTestCase):
    ...
    def test_public_holiday_is_holiday_check(self):
        ...
        self.assertTrue(
            PublicHoliday.is_holiday(self.company.id, date(2025, 7, 4))
        )
        self.assertFalse(
            PublicHoliday.is_holiday(self.company.id, date(2025, 7, 5))
        )
