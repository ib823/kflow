...
class KfAuditLog(models.Model):
    ...
    @api.model
    def log(self, action, user_id=None, company_id=None, entity_type=None,
    ...
    @api.model
    def log_data_access(self, action, user_id, entity_type, entity_id,
                        ip_address=None):
    ...
    @api.model
    def log_data_change(self, action, user_id, entity_type, entity_id,
