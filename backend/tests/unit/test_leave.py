...
class TestLeaveBalance:
    ...
    def test_available_balance_excludes_pending(self, sample_leave_balance):
        ...
        balance = sample_leave_balance
        available = (balance['entitled'] + balance['carried'] +
                    balance['adjustment'] - balance['taken'] - balance['pending'])
    ...
    def test_negative_balance_not_allowed(self, sample_leave_balance):
        ...
        balance = sample_leave_balance
        total_available = (balance['entitled'] + balance['carried'] +
                          balance['adjustment'] - balance['taken'])
...
class TestLeaveRequest:
    ...
    def test_leave_request_requires_balance(self, sample_leave_balance, sample_leave_request):
        ...
        available = (sample_leave_balance['entitled'] + sample_leave_balance['carried'] +
                    sample_leave_balance['adjustment'] - sample_leave_balance['taken'] -
